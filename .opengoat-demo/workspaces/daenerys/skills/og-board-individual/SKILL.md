...
Replace `daenerys` with your agent id.

```text
opengoat_agent_info({ "agentId": "daenerys" })
```
...
```text
opengoat_task_list({ "assignee": "daenerys" })
...
opengoat_task_add_blocker({ "actorId": "daenerys", "taskId": "<task-id>", "blocker": "..." })
opengoat_task_add_artifact({ "actorId": "daenerys", "taskId": "<task-id>", "content": "..." })
opengoat_task_add_worklog({ "actorId": "daenerys", "taskId": "<task-id>", "content": "..." })
```
...
```text
opengoat_task_list_latest({ "assignee": "daenerys", "limit": 20 })
```
...
```text
opengoat_task_update_status({ "actorId": "daenerys", "taskId": "<task-id>", "status": "doing" })
opengoat_task_update_status({ "actorId": "daenerys", "taskId": "<task-id>", "status": "blocked", "reason": "Need API token from platform team" })
opengoat_task_update_status({ "actorId": "daenerys", "taskId": "<task-id>", "status": "pending", "reason": "Waiting for review window on Friday" })
opengoat_task_update_status({ "actorId": "daenerys", "taskId": "<task-id>", "status": "done", "reason": "Merged PR #123 and deployed" })
```
