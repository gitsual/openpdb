...
Replace `tony-stark` with your agent id.

```text
opengoat_agent_info({ "agentId": "tony-stark" })
```
...
```text
opengoat_task_list({ "assignee": "tony-stark" })
...
opengoat_task_add_blocker({ "actorId": "tony-stark", "taskId": "<task-id>", "blocker": "..." })
opengoat_task_add_artifact({ "actorId": "tony-stark", "taskId": "<task-id>", "content": "..." })
opengoat_task_add_worklog({ "actorId": "tony-stark", "taskId": "<task-id>", "content": "..." })
```
...
```text
opengoat_task_list_latest({ "assignee": "tony-stark", "limit": 20 })
```
...
```text
opengoat_task_update_status({ "actorId": "tony-stark", "taskId": "<task-id>", "status": "doing" })
opengoat_task_update_status({ "actorId": "tony-stark", "taskId": "<task-id>", "status": "blocked", "reason": "Need API token from platform team" })
opengoat_task_update_status({ "actorId": "tony-stark", "taskId": "<task-id>", "status": "pending", "reason": "Waiting for review window on Friday" })
opengoat_task_update_status({ "actorId": "tony-stark", "taskId": "<task-id>", "status": "done", "reason": "Merged PR #123 and deployed" })
```
