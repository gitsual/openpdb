...
Replace `joker` with your agent id.

```text
opengoat_agent_info({ "agentId": "joker" })
```
...
```text
opengoat_task_list({ "assignee": "joker" })
...
opengoat_task_add_blocker({ "actorId": "joker", "taskId": "<task-id>", "blocker": "..." })
opengoat_task_add_artifact({ "actorId": "joker", "taskId": "<task-id>", "content": "..." })
opengoat_task_add_worklog({ "actorId": "joker", "taskId": "<task-id>", "content": "..." })
```
...
```text
opengoat_task_list_latest({ "assignee": "joker", "limit": 20 })
```
...
```text
opengoat_task_update_status({ "actorId": "joker", "taskId": "<task-id>", "status": "doing" })
opengoat_task_update_status({ "actorId": "joker", "taskId": "<task-id>", "status": "blocked", "reason": "Need API token from platform team" })
opengoat_task_update_status({ "actorId": "joker", "taskId": "<task-id>", "status": "pending", "reason": "Waiting for review window on Friday" })
opengoat_task_update_status({ "actorId": "joker", "taskId": "<task-id>", "status": "done", "reason": "Merged PR #123 and deployed" })
```
