...
Important: replace `wonder-woman` with your agent ID.

```text
opengoat_agent_info({ "agentId": "wonder-woman" })
```

## Task Tools

```text
opengoat_task_list({ "assignee": "wonder-woman" })
opengoat_task_get({ "taskId": "<task-id>" })
opengoat_task_create({
  "actorId": "wonder-woman",
  "title": "...",
  "description": "...",
  "assignedTo": "<agent-id>"
})
...
opengoat_task_add_blocker({ "actorId": "wonder-woman", "taskId": "<task-id>", "blocker": "..." })
opengoat_task_add_artifact({ "actorId": "wonder-woman", "taskId": "<task-id>", "content": "..." })
opengoat_task_add_worklog({ "actorId": "wonder-woman", "taskId": "<task-id>", "content": "..." })
```
