...
Important: replace `ripley` with your agent ID.

```text
opengoat_agent_info({ "agentId": "ripley" })
```

## Task Tools

```text
opengoat_task_list({ "assignee": "ripley" })
...
opengoat_task_add_blocker({ "actorId": "ripley", "taskId": "<task-id>", "blocker": "..." })
opengoat_task_add_artifact({ "actorId": "ripley", "taskId": "<task-id>", "content": "..." })
opengoat_task_add_worklog({ "actorId": "ripley", "taskId": "<task-id>", "content": "..." })
```
