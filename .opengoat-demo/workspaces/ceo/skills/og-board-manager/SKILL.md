...
Important: replace `ceo` with your agent ID.
...
```text
opengoat_task_list({ "assignee": "ceo" })
...
opengoat_task_add_blocker({ "actorId": "ceo", "taskId": "<task-id>", "blocker": "..." })
opengoat_task_add_artifact({ "actorId": "ceo", "taskId": "<task-id>", "content": "..." })
opengoat_task_add_worklog({ "actorId": "ceo", "taskId": "<task-id>", "content": "..." })
```
