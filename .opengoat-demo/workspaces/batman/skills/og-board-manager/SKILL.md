...
Important: replace `batman` with your agent ID.

```text
opengoat_agent_info({ "agentId": "batman" })
```

## Task Tools

```text
opengoat_task_list({ "assignee": "batman" })
...
opengoat_task_add_blocker({ "actorId": "batman", "taskId": "<task-id>", "blocker": "..." })
opengoat_task_add_artifact({ "actorId": "batman", "taskId": "<task-id>", "content": "..." })
opengoat_task_add_worklog({ "actorId": "batman", "taskId": "<task-id>", "content": "..." })
```
